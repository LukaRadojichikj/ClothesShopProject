               ...
               new Shop
               {
                ...
                context.Brand.AddRange(
                    new Brand
                    {
                        ...
                        ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id
                    },
                    new Brand
                    {
                        Name = "Adidas",
                    ...
                    new Brand
                    {
                        ...
                        ShopId = context.Shop.Single(x => x.Name == "Lobby").Id
                    },
                    new Brand
                    {
                        Name = "New Balance",
                        ...
                        ShopId = context.Shop.Single(x => x.Name == "BSTN").Id
                    },
                    new Brand
                    {
                        Name = "The North Face",
                ...
                context.ShopApparelShoe.AddRange(
                        ...
                        {
                            ShopId = context.Shop.Single(x => x.Name == "Lobby").Id,
                            ApparelId = context.Apparel.Single(x => x.Name == "Carhartt Utah Waistcoat").Id,
                            ShoeId = null,
                            Price = 279.99m // Set the price for this combination
                        },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Puma Clyde Vintage").Id,
                           Price = 109.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Nike Life Heavy Waffle Longsleeve").Id,
                           ShoeId = null,
                           Price = 69.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "New Balance Hoops Fleece Hoodie").Id,
                           ShoeId = null,
                           Price = 79.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "New Balance Hoops Essentials Shorts").Id,
                           ShoeId = null,
                           Price = 49.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Puma x Rhuigi Double Knee Pants").Id,
                           ShoeId = null,
                           Price = 69.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Puma x BMW Longsleeve").Id,
                           ShoeId = null,
                           Price = 59.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Adidas 3 Stripes Tee").Id,
                           ShoeId = null,
                           Price = 35.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Adidas x Wales Bonner Tee").Id,
                           ShoeId = null,
                           Price = 59.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Nike Jordan Essentials Renegade Jacket").Id,
                           ShoeId = null,
                           Price = 249.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "Nike Authentics Lined Coaches Jacket").Id,
                           ShoeId = null,
                           Price = 109.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Lobby").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "The North Face Gore-Tex Mountain Pant").Id,
                           ShoeId = null,
                           Price = 249.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Lobby").Id,
                           ApparelId = context.Apparel.Single(x => x.Name == "The North Face Gore-Tex Mountain Guide Insulated").Id,
                           ShoeId = null,
                           Price = 699.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Puma Velophasis Technish").Id,
                           Price = 79.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Puma Palermo OG").Id,
                           Price = 99.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "New Balance ML610TBI").Id,
                           Price = 129.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "BSTN").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "New Balance BB480LWA").Id,
                           Price = 99.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Lobby").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "The North Face NSE Low").Id,
                           Price = 59.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Lobby").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "The North Face Nuptse Mule").Id,
                           Price = 79.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Adidas Samba OG").Id,
                           Price = 149.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Adidas Gazelle").Id,
                           Price = 109.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Nike Terminator Low").Id,
                           Price = 129.99m // Set the price for this combination
                       },
                       new ShopApparelShoe
                       {
                           ShopId = context.Shop.Single(x => x.Name == "Asphalt Gold").Id,
                           ApparelId = null,
                           ShoeId = context.Shoe.Single(a => a.Name == "Nike Dunk High Retro").Id,
                           Price = 129.99m // Set the price for this combination
                       }
